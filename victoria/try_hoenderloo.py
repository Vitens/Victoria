...
timestep = 5  # minutes,  timestep for solving PHREEQC
time_end = 1  # hours,   maximum duration of the simulation
time_phreeqc = 1  # hours   timestep for changing PHREEQC solutions at reservoirs
time_report = 15  # minutes  timestep for reporting the result
...
# Initialize Epynet
network1 = Network('Pb_Hoenderloo (3).inp')
...
conc = []
solutions[network1.reservoirs['Pb_Hoenderloo_Apeldoorn_P'].uid] = sol1
solutions[network1.reservoirs['Opj_Koeweg_Otterlo_Q'].uid] = sol4
